 ...
 */
@Entity
public class Reintegration extends Operations{
public String type;
    ...
    public Reintegration(Long idOpt, String couleur, String dateOperation, Magasins magasins, Magasins magasin, Equipe equipe, String numScelle) {
