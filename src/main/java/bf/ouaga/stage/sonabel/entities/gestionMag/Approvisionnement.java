 ...
 */
@Entity
public class Approvisionnement extends Operations{
public String type;
    ...
    public Approvisionnement(Long idOpt, String couleur, String dateOperation, Magasins magasins, Magasins magasin, Equipe equipe, String numScelle) {
